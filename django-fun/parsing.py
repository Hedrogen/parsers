"""
    ...
    # 1. Получить div с id s-django-documentation .section  + #
    # 2. Вытащить оттуда все div с .section                 + #
    # 3. Из .section вытащить заголовок h2                  + #
    # 4. Из .section вытащить краткое описание p            + #
    # 5. Из ul с .simple вытащить все li                    + #
    # 6. Из li вытащить название темы strong                + #
    # 7. Из reference internal вытащить ссылку и название   + #
